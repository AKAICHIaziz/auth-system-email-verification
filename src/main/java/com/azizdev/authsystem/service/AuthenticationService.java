...
public class AuthenticationService {
    ...
    public User authenticate(LoginUserDto input) {
        ...
        if (!user.isEnabled()) {
            throw new RuntimeException("Account not verified please check your inbox and verify your account");
        }
    ...
    public void verifyUser(VerifyUserDto input) {
        ...
        if (optionalUser.isPresent()) {
            ...
            if (user.getVerificationCodeExpiresAt().isBefore(LocalDateTime.now())){
                throw new RuntimeException("Verification code is expired please try again");
            }
    ...
    public void sendVerificationEmail(User user) {
        ...
        String htmlMessage = "<html>"
                ...
                + "</html>";
        try{
            emailService.sendVerificatioEmail(user.getEmail(), subject, htmlMessage);
